    ...
    <div className="min-h-screen flex flex-col bg-[#FAF8F4] text-[#0D0D0D]">
      ...
      <div className="sticky top-0 z-50 w-full pt-4 px-4 transition-all duration-300">
        <header className={clsx(
          ...
          scrolled 
            ? "h-[58px] px-6 border-ink/10 bg-[#FAF8F4]/85 backdrop-blur-xl rounded-full shadow-[0_12px_40px_-12px_rgba(13,13,13,0.08)]"
            : "h-[68px] px-8 border-ink/5 bg-white/60 backdrop-blur-md rounded-3xl shadow-[0_8px_30px_rgba(13,13,13,0.02)]"
        )}>
          <div className="flex items-center gap-8">
            <TransitionLink href="/" className="font-display text-xl tracking-wide flex items-center gap-4 group cursor-pointer">
