...
import { ArrowLeft, User, Mail, CreditCard, BarChart2, ShieldCheck, Key, RefreshCw, Copy, Check, Save, Sparkles, BookOpen, Layers } from "lucide-react";
    ...
    <div className="min-h-screen flex flex-col bg-gradient-to-br from-[#FAF8F4] via-[#FDFCF7] to-[#F6F3EB] text-[#0D0D0D] relative overflow-hidden font-sans">
      ...
      <div className="flex flex-1 relative z-10">
        ...
        <aside className="w-[240px] border-r border-[#0D0D0D]/5 bg-white/40 backdrop-blur-xl shrink-0 flex flex-col justify-between transition-all duration-300">
          ...
          <div className="p-6 border-t border-[#0D0D0D]/5 bg-white/40">
                    ...
                    <div>
                      <div className="flex items-center gap-4 border-b border-[#0D0D0D]/5 pb-4">
                        ...
                        <div className="flex flex-col">
                          ...
                          <span className="px-2 py-0.5 rounded-full font-mono text-[7px] uppercase tracking-wider bg-amber-50 text-amber-800 border border-amber-200/50 w-max mt-0.5 font-bold">Free Plan</span>
                        </div>
                      </div>
